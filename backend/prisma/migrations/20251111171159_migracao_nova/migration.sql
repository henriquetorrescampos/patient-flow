...
-- CreateIndex
CREATE INDEX "History_patientId_idx" ON "History"("patientId");

-- CreateIndex
CREATE INDEX "History_area_idx" ON "History"("area");
...
-- AddForeignKey
ALTER TABLE "History" ADD CONSTRAINT "History_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "Patient"("id") ON DELETE CASCADE ON UPDATE CASCADE;
